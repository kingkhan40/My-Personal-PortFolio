      ...
      <nav className="nav-container">
        ...
        <div className={Toggle ? "nav__menu show-menu" : "nav__menu"}>
          <ul className="nav__list grid">
            ...
            <li className="nav__item">
              <a href="#qualifectaion"
                onClick={() => setActiveNav("#qualifectaion")}
                className={
                  activeNav === "#qualifectaion" ? "nav__link active-link" : "nav__link"
                }>
            ...
            <li className="nav__item">
              <a href="#contact"
                ...
                <i className="uil uil-message nav__icon"></i>Contect
              </a>
            </li>
          </ul>
          <i
